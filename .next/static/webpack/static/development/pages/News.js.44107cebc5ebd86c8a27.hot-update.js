...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";@media (max-width:768px){flex-direction:column;width:100%;max-width:100%;justify-content:space-between;padding:0;margin:16px auto;height:auto;}"], function (props) {
...
//# sourceMappingURL=News.js.44107cebc5ebd86c8a27.hot-update.js.map