...
})(["border-radius:4px;padding:", ";font-size:", ";background:", ";color:", ";font-family:'Sans'"], function (props) {
  return props.small && '6px 10px' || '10px 14px';
}, function (props) {
  return props.small && '10px' || '16px';
}, function (props) {
...
//# sourceMappingURL=index.js.6e3bb380b285bcedd544.hot-update.js.map