...
})(["position:relative;background:", ";color:", ";font-size:12px;font-weight:400;font-family:'Roboto';width:100%;outline:none;text-align:center;border:none;border-radius:6px;margin:0 6px;margin-left:16px;@media (max-width:768px){font-size:12px;font-weight:400;padding:4px 6px;}"], function (props) {
  return props.theme.bgColor;
}, function (props) {
  return props.theme.color;
});
...
//# sourceMappingURL=index.js.60023e06254ac1393304.hot-update.js.map