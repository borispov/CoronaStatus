...
})(["margin:0 auto;width:85%;direction:rtl;"]);
...
})(["font-size:12px;font-weight:700;padding-bottom:12px;transform:rotate(-22deg);"]);
  ...
  var newsToTemplate = function newsToTemplate(news) {
    return news.map(function (item, idx) {
      return __jsx(NewsCard, {
        ...
        __self: this
      }, showSource(item.href))), __jsx(_components_S__WEBPACK_IMPORTED_MODULE_3__["Heading2"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 67
        },
...
//# sourceMappingURL=News.js.75d4ac1eba57615e4f6f.hot-update.js.map