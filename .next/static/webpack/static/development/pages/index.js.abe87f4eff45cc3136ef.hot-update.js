...
var Btn = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button.withConfig({
...
})(["border-radius:", ";padding:", ";font-size:", ";background:", ";color:", ";border:", ";font-family:'Sans';border:", ";font-weight:", ";cursor:", ";outline:none;line-height:1.5;margin:", ";@media (max-width:450px){font-size:12px;font-weight:normal;padding:1px 4px;}"], function (props) {
  ...
  return props.secondary ? props.theme.success.main : props.bgColor ? props.theme.bgColor : props.error ? props.theme.error : props.theme.primaryColor;
}, function (props) {
...
//# sourceMappingURL=index.js.abe87f4eff45cc3136ef.hot-update.js.map