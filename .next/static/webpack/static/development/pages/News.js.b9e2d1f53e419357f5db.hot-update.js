...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;border:1px solid gray;justify-content:space-between;@media (max-width:768px){width:100%;max-width:100%;flex-direction:column;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";padding:0;margin:16px auto;height:auto;}"], function (props) {
...
})(["margin-left:42px;width:48px;height:48px;display:block;border:1px solid gray;@media (max-width:768px){margin-left:8px;width:124px;height:auto;border:0;flex:0 0 20%;img{width:124px;height:100%;}}"]);
...
})(["font-weight:600;font-family:'Roboto';@media (max-width:768px){max-width:fit-content;}"]);
...
//# sourceMappingURL=News.js.b9e2d1f53e419357f5db.hot-update.js.map