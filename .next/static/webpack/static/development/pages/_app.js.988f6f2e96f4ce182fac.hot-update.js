...
})(["justify-content:space-between;align-items:center;max-width:920px;margin:0 auto;box-shadow:0 0.3px 0.9px rgba(0,0,0,0.12),0 1.6px 3.6px rgba(0,0,0,0.12);@media (max-width:580px){margin-left:12px;margin-right:12px;align-items:flex-end;padding-top:4px;}"]);
...
//# sourceMappingURL=_app.js.988f6f2e96f4ce182fac.hot-update.js.map