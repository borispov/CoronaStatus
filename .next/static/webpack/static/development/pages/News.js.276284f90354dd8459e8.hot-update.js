...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";flex-direction:column;width:100%;max-width:100%;justify-content:space-between;padding:0;margin:16px auto;height:auto;@media (max-width:768px){height:150px;}"], function (props) {
...
//# sourceMappingURL=News.js.276284f90354dd8459e8.hot-update.js.map