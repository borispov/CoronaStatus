...
})(["margin-left:42px;width:48px;height:48px;display:block;border:1px solid gray;@media (max-width:768px){margin:0;float:left;width:96px;height:96px;border:0;img{width:96px;height:96px;border-radius:4px;}}"]);
...
//# sourceMappingURL=News.js.99f54b5d5a4325a0891e.hot-update.js.map