...
var Para = Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(_components_S__WEBPACK_IMPORTED_MODULE_3__["Paragraph"]).withConfig({
  displayName: "News__Para",
  componentId: "sc-1dpkj34-4"
})(["text-overflow:ellipsis;white-space:nowrap;max-width:350px;"]);
  ...
  var newsToTemplate = function newsToTemplate(news) {
    return news.map(function (item, idx) {
      return __jsx(NewsCard, {
        ...
        __self: this
      }, item.title), __jsx(Para, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 84
        },
        __self: this
      }, " padding='0' noMargin fontSize='12px'>", item.description)))), __jsx(_components_S__WEBPACK_IMPORTED_MODULE_3__["Flex"], {
...
//# sourceMappingURL=News.js.ec0a695a4400e86c88df.hot-update.js.map