...
})(["display:inline-block;vertical-align:middle;padding:16px;text-align:center;font-size:222x;font-weight:500;margin-left:18px;margin-right:18px;width:80px;height:64px;border:1px solid ", ";background:", ";border-radius:4px;color:", ";border-bottom:4px solid gray;border-top:4px solid gray;border-right:1px solid gray;border-left:1px solid gray;position:relative;text-shadow:0px 1px 3px rgba(0,0,0,0.16) 1px 2px 4px rgba(0,0,0,0.26);"], function (props) {
  return props.theme.color;
}, function (props) {
  return props.theme.bgColor;
}, function (props) {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["withTheme"])(function (_ref) {
  ...
  return __jsx("simpleWrapper", {
    ...
    __self: this
  }, counter, "$")), __jsx(_components_S__WEBPACK_IMPORTED_MODULE_1__["Heading"], {
    fontSize: "18px",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 106
    ...
    __self: this
  }, !isHeb ? 'Minimum 2$ Coffee' : 'מינימום 2$ קפה שחור'), __jsx(ErrorText, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108
    },
...
//# sourceMappingURL=Coffee.js.bf5a471dabddd2dcf431.hot-update.js.map