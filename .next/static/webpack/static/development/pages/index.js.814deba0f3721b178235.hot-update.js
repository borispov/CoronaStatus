...
})(["color:#e6e6e6;font-size:2.5rem;font-family:monospace;text-align:center;text-shadow:0 1px 35px rgba(5,35,10,0.2);"]);
var Wrap = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].header.withConfig({
  displayName: "Header__Wrap",
  componentId: "sc-1yguf34-1"
})(["direction:ltr;display:flex;justify-content:space-between;position:relative;height:82px;width:100%;background:linear-gradient(45deg,#5c0434,#000000d6);border-bottom:1px solid darkblue;margin:0 auto;margin-bottom:48px;"]);
...
})(["display:flex;flex-flow:", ";justify-content:center;"], function (props) {
...
//# sourceMappingURL=index.js.814deba0f3721b178235.hot-update.js.map