...
})(["border:1px solid ", ";box-shadow:", ";border-radius:'6px';margin-bottom:'16px; background: ", ""], function (props) {
  return props.theme.text.disabled;
}, function (props) {
  return props.theme.shadows[3];
}, function (props) {
  return props.theme.bgColor2;
});
...
//# sourceMappingURL=index.js.6f42ff9b72382e537c1e.hot-update.js.map