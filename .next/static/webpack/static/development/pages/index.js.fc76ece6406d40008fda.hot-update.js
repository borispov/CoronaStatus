...
var CoronaApp = function CoronaApp(_ref) {
  ...
  var countryheb = function countryheb(x) {
    return countries && _assets_cns_js__WEBPACK_IMPORTED_MODULE_12__["default"][countries.map(function (a) {
      return a.toLowerCase();
    }).indexOf(x)];
  };

  console.log(countries && country);
  console.log(countries && countries); // const selectOptions = countries && countries.map(a => ({ value: a, label: a }))
...
//# sourceMappingURL=index.js.fc76ece6406d40008fda.hot-update.js.map