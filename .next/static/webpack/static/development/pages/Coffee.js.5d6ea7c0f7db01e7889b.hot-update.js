...
/* harmony default export */ __webpack_exports__["default"] = (Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["withTheme"])(function (_ref) {
  ...
  var instructionsHeb = ['אפשרות 1: תרומה דרך ממשק של ko-fi.com. הנכם תהיו מועברים לדף ה״קופי״ שלי, דרכו תוכלו להשאיר טיפ עם הודעה. שימו לב, ניתן לתרום ללא הרשמה! במידה ותתבקשו להירשם, ליחצו על הכפתור התחתון להרשמה - אתם תועברו לדף של ביצוע תשלום ותוכלו להירש אם תרצו.', 'אפשרות 2: העברת טיפ ישירות דרך paypal. תוכלו לבחור כל סכום, אך ללא הודעה. \n* אני ממליץ להשתמש בממשק ko-fi.com. אפשרות התרומה דרך פייפאל מוצגת כאן עבור אלו שאינם מסתדרים עם תשלום דרך ko-fi.com'];
  ...
  var instructionToRender = instruction(instructionsHeb);
  ...
  return __jsx("simpleWrapper", {
    ...
    __self: this
  }, isHeb ? 'חזור' : 'Back')))))), __jsx(Heading2, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 199
    },
    __self: this
  }, instructions(instructionsHeb)))));
}));

/***/ })

})
//# sourceMappingURL=Coffee.js.5d6ea7c0f7db01e7889b.hot-update.js.map