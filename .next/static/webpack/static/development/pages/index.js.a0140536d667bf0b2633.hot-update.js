...
})(["position:relative;background:", ";color:", ";font-size:12px;font-weight:400;font-family:'Roboto';outline:none;text-align:center;border:none;border-radius:6px;margin:0 6px;margin-left:16px;"], function (props) {
  return props.theme.bgColor;
}, function (props) {
  return props.theme.color;
});
...
//# sourceMappingURL=index.js.a0140536d667bf0b2633.hot-update.js.map