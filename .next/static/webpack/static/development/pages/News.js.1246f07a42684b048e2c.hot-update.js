...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;border:1px solid gray;justify-content:space-between;@media (max-width:768px){width:100%;max-width:100%;flex-direction:column;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";padding:0;margin:16px auto;height:350px;}"], function (props) {
...
//# sourceMappingURL=News.js.1246f07a42684b048e2c.hot-update.js.map