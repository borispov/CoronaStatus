...
function MyApp(_ref) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", currentCountry());
  ...
  function currentCountry() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function currentCountry$(_context3) {
      while (1) {
  ...
  var userLocation = currentCountry();

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(lightTheme()),
      theme = _useState[0],
      setTheme = _useState[1];

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(userLocation && (userLocation === 'israel' || userLocation === 'Israel' ? true : false) || 'true'),
      isHeb = _useState2[0],
      setHeb = _useState2[1];
...
MyApp.getInitialProps = function _callee2(appContext) {
  var appProps;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function _callee2$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          appProps = _context4.sent;
          return _context4.abrupt("return", _objectSpread({}, appProps));
...
//# sourceMappingURL=_app.js.9f341abf9f3986b82dce.hot-update.js.map