...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";flex-direction:column;width:100%;max-width:100%;justify-content:space-between;padding:0;margin:16px auto;height:auto;@media (max-width:768px){}"], function (props) {
...
//# sourceMappingURL=News.js.1c8966ba2aaf9cc17c69.hot-update.js.map