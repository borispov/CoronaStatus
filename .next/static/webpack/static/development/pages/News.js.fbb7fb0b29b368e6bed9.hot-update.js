...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;border:1px solid gray;justify-content:space-between;@media (max-width:768px){width:100%;max-width:100%;flex-direction:column;border-radius:6px;border:1px solid ", ";border-top:4px;padding:0;margin:16px auto;}"], function (props) {
...
//# sourceMappingURL=News.js.fbb7fb0b29b368e6bed9.hot-update.js.map