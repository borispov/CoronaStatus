...
})(["position:relative;background:", ";color:", ";padding:0.210rem 0.45rem;font-size:12px;font-weight:400;font-family:'Roboto';outline:none;text-align:center;border:none;border-radius:6px;margin:0 6px;margin-left:16px;"], function (props) {
  return props.theme.bgColor;
}, function (props) {
  return props.theme.color;
});
...
//# sourceMappingURL=index.js.43df6462941a00544e56.hot-update.js.map