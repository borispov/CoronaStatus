...
var Btn = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button.withConfig({
...
})(["border-radius:", ";padding:", ";font-size:", ";background:", ";color:", ";border:", ";font-family:'Sans';font-weight:", ";cursor:", ";outline:none;line-height:1.5;margin:", ";box-shadow:", ";letter-spacing:", ";transition:all 0.3s ease-in-out;&:hover{transform:", ";background:", ";}@media (max-width:450px){font-size:12px;font-weight:normal;}"], function (props) {
  ...
  return props.letterSpace ? '1.2px' : '0';
}, function (props) {
  return props.hoverUp ? 'translateY(-5%)' : '';
}, function (props) {
  return props.hoverColor && props.theme[props.hoverColor];
});
...
//# sourceMappingURL=index.js.cbb4708a4a72d1a9480d.hot-update.js.map