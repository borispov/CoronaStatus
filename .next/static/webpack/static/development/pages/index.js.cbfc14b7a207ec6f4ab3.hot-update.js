...
})(["text-align:none;display:flex;flex-wrap:wrap;justify-content:center;margin-left:15px;margin-right:15px;margin-bottom:32px;@media (max-width:768px){flex-direction:column;}"]);
...
})(["border-radius:4px;background:", ";color:", ";flex:0 0 50%;max-width:33%;position:relative;width:100%;border:1px solid;border-color:", ";margin:2px;@media (max-width:768px){flex-direction:column;flex:0 0 100%;max-width:85%;}"], function (props) {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    function fetchData() {
      var init, _ref2, _data, datakeys, d;
...
//# sourceMappingURL=index.js.cbfc14b7a207ec6f4ab3.hot-update.js.map