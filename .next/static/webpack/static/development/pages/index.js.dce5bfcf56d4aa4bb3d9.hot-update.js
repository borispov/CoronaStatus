...
var fadeIn = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].keyframes.withConfig({
  displayName: "LineChart__fadeIn",
  componentId: "sc-9esmyi-0"
})(["from{transform:scale(.25);opacity:0;}to{transform:scale(1);opacity:1;}"]);
...
})(["margin-top:32px;margin-left:auto;margin-right:auto;margin-bottom:48px;height:375px;text-align:center;width:80%;direction:rtl;animation:fadeIn 2s ease-in;> *{direction:rtl;}@media (max-width:768px){height:40vh;margin-bottom:48px;width:80vw;max-width:80%;}"]);
...
//# sourceMappingURL=index.js.dce5bfcf56d4aa4bb3d9.hot-update.js.map