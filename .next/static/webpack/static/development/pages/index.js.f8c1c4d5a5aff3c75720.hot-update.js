...
})(["text-align:none;display:flex;flex-wrap:wrap;justify-content:center;margin-left:15px;margin-right:15px;margin-bottom:32px;@media (max-width:568px){flex-direction:column;}"]);
...
})(["border-radius:4px;background:", ";color:", ";flex:0 0 50%;max-width:33%;position:relative;width:100%;border:1px solid;border-color:", ";margin:2px;@media (max-width:568px){flex-direction:column;flex:0 0 100%;}"], function (props) {
...
//# sourceMappingURL=index.js.f8c1c4d5a5aff3c75720.hot-update.js.map