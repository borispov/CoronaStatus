...
var parseLabel = function parseLabel(label) {
  ...
  return toString(d.getDate() + '.' + d.getMonth());
};
...
var sortForChart = function sortForChart(obj) {
  ...
  var shortLabels = labels.map(function (label) {
    var d = new Date(label);
    var dd = "".concat(d.getDate() + '.' + d.getMonth());
    console.log(dd);
    return "".concat(d.getDate() + '.' + d.getMonth());
  });
  var datasets = [{
    label: 'new cases',
    data: newCases,
...
//# sourceMappingURL=index.js.71c94407ab809441d8b4.hot-update.js.map