...
var closeStyle = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["css"])(["@media (max-width:960px){display:none;}display:flex;width:auto;flex-flow:row;justify-content:flex-start;display:flex;justify-content:space-around;margin:12px 0 0;.divv{font-size:16px;color:white;cursor:pointer;&:hover{color:", ";}}a{font-family:'Rubik';padding:0px 20px;text-decoration:none;color:", ";transition:all 0.15s ease-in-out;&:hover{color:", ";text-shadow:1px 2px 3px rgba(0,0,0,0.2) 0px 2px 1px rgba(0,0,0,0.16);}}span{display:none;}"], function (_ref4) {
...
//# sourceMappingURL=_app.js.6029b2dee3b881584068.hot-update.js.map