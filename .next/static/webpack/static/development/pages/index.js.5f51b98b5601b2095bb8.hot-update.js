...
var Btn = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button.withConfig({
...
})(["border-radius:", ";padding:", ";font-size:", ";background:", ";border:", ";color:", ";font-family:'Sans';border:", ";font-weight:", ";cursor:", ";outline:none;line-height:1.5;margin:", ";@media (max-width:450px){font-size:12px;font-weight:normal;padding:1px 4px;}"], function (props) {
  ...
  return props.bgColor && props.bgColor || props.outline && '' || props.theme.primary;
}, function (props) {
  return props.outline ? "1px solid ".concat(props.theme.primaryColor) : '';
}, function (props) {
...
//# sourceMappingURL=index.js.5f51b98b5601b2095bb8.hot-update.js.map