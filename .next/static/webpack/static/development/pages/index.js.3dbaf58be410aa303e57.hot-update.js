...
})(["position:relative;background:", ";color:", ";font-size:12px;font-weight:400;font-family:'Roboto';padding:4px 6px;width:100%;outline:none;text-align:center;border:none;border-radius:6px;@media (max-width:768px){font-size:12px;font-weight:400;padding:4px 6px;}"], function (props) {
  return props.theme.bgColor;
}, function (props) {
  return props.theme.color;
});
...
//# sourceMappingURL=index.js.3dbaf58be410aa303e57.hot-update.js.map