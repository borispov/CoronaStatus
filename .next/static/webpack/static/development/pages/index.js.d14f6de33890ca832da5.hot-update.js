...
})(["display:flex;flex-direction:", ";justify-content:", ";margin:", ";color:", ";align-items:", ";flex:", ";background:", ";@media (max-width:768px){flex-direction:", ";}"], function (props) {
...
})(["font-size:", ";padding:", ";color:", ";font-family:", ";background:", ";white-space:", ";max-width:450px;text-overflow:", ";@media (max-width:768px){font-size:12px;font-weight:700;max-width:100%;}"], function (props) {
...
})(["font-size:", ";max-width:", ";max-width:fit-content;margin:", ";line-height:", ";padding:", ";color:", ";@media (max-width:768px){font-size:11px;font-weight:300;max-width:fit-content;overflow:hidden;margin:0;padding:0;}"], function (props) {
...
//# sourceMappingURL=index.js.d14f6de33890ca832da5.hot-update.js.map