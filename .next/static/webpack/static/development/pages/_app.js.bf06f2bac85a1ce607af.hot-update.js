...
var closeStyle = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["css"])(["@media (max-width:960px){display:none;}display:flex;width:auto;flex-flow:row;justify-content:flex-start;display:flex;justify-content:space-around;margin:12px 0 0;.divv{font-size:16px;color:white;cursor:pointer;&:hover{color:", ";}}a{font-family:'Rubik';padding:0px 20px;text-decoration:none;color:", ";transition:all 0.15s ease-in-out;&:hover{color:", ";font-weight:500;}}span{display:none;}"], function (_ref4) {
...
//# sourceMappingURL=_app.js.bf06f2bac85a1ce607af.hot-update.js.map