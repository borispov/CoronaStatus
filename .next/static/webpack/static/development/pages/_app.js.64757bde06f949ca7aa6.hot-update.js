...
})(["display:flex;flex-direction:column;justify-content:center;background:", ";color:", ";height:auto;position:absolute;z-index:999;top:0;right:10%;direction:rtl;width:30%;border-bottom-left-radius:6px;border-bottom:2px solid;border-bottom-color:{$props => props.theme.menuBorder};border-bottom-right-radius:6px;transition:transform 0.22s ease-in-out;transform:", ";@media (max-width:", "){width:100%;}.divv{z-index:9999;display:flex:flex-direction:row;justify-content:flex-start;padding:10px 6px;text-align:center;}span{margin-right:18px;margin-right:18px;font-size:14px;color:", ";@media (max-width:768px){font-size:12px;}}a{padding:4px;cursor:pointer;font-size:18px;font-weight:bold;letter-spacing:0.15rem;color:#F1F1F1;text-decoration:none;transition:color 0.15s linear;@media (max-width:", "){font-size:12px;}&:hover{color:", ";}}"], function (props) {
...
//# sourceMappingURL=_app.js.64757bde06f949ca7aa6.hot-update.js.map