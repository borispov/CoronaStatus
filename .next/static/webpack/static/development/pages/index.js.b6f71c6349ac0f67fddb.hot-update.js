...
})(["position:relative;background:", ";color:", ";font-size:14px;font-weight:600;padding:6px 10px;width:100%;outline:none;text-align:center;border:none;border-radius:6px;margin:0 6px;@media (max-width:768px){width:30px;font-size:12px;font-weight:400;padding:4px 6px;}"], function (props) {
  return props.theme.bgColor;
}, function (props) {
  return props.theme.color;
});
function IndexPage() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx(styled_components__WEBPACK_IMPORTED_MODULE_2__["ThemeProvider"], {
    ...
    __self: this
  }, themeButton, __jsx(_components_Button__WEBPACK_IMPORTED_MODULE_9__["default"], {
...
//# sourceMappingURL=index.js.b6f71c6349ac0f67fddb.hot-update.js.map