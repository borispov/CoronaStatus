...
})(["margin-left:42px;width:48px;height:48px;display:block;border:1px solid gray;@media (max-width:768px){margin:0;width:100%;height:124px;}"]);
...
})(["font-size:12px;font-weight:700;padding-bottom:8px;transform:rotate(-15deg);@media (max-width:768px){transform:rotate(0);padding:0;}img{width:100%;height:124px;}"]);
...
//# sourceMappingURL=News.js.77e1fd82053ad2cbb9c2.hot-update.js.map