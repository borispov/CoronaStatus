...
})(["direction:ltr;margin:6px;padding:8px;> button{margin-left:12px;}"]);
var BoxFlex = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div.withConfig({
  displayName: "Coffee__BoxFlex",
  componentId: "wfmxm6-4"
})(["margin-top:24px;display:flex;flex-direction:column;justify-content:space-between;align-items:middle;> button{margin:12px;}@media (min-width:660px){flex-direction:row;justify-content:space-evenly;}"]);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["withTheme"])(function (_ref) {
  ...
  return __jsx("simpleWrapper", {
    ...
    __self: this
  }, error ? isHeb && errorHeb || errorEng : ''), __jsx(Message, {
    fontSize: "18px",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 143
    ...
    __self: this
  }, __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_S__WEBPACK_IMPORTED_MODULE_1__["Button"], {
    pointer: true,
    bg: "primaryColor",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, isHeb ? 'תרומה דרך: ko-fi.com' : 'Support via ko-fi.com')), __jsx(_components_S__WEBPACK_IMPORTED_MODULE_1__["Button"], {
    pointer: true,
    bg: "primaryVariant",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, isHeb ? 'תרומה דרך: paypal' : 'Support via ko-fi.com'))), __jsx(_components_S__WEBPACK_IMPORTED_MODULE_1__["Button"], {
    pointer: true,
    bg: "grey",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=Coffee.js.b61cf675ec7360c5dd50.hot-update.js.map