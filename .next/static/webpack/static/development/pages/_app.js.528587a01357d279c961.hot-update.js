...
})(["direction:ltr;position:relative;height:64px;z-index:1;width:100%;background:linear-gradient(45deg,#5c0434,#000000d6);background:linear-gradient(45deg,", ",#000000d6);border-bottom:1px solid darkblue;margin:0 auto;margin-bottom:48px;box-shadow:0 0.3px 0.9px rgba(0,0,0,0.12),0 1.6px 3.6px rgba(0,0,0,0.12);"], function (props) {
...
//# sourceMappingURL=_app.js.528587a01357d279c961.hot-update.js.map