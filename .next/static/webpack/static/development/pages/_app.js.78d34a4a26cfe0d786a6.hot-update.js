...
})(["margin-top:10px;color:#e6e6e6;font-size:3.5rem;font-family:'Montserrat';text-align:center;text-shadow:0 1px 35px rgba(5,35,10,0.2);cursor:pointer;font-family:'Montserrat';box-shadow:", ";@media (max-width:580px){font-size:3rem;align-items:flex-end;}"], function (props) {
...
//# sourceMappingURL=_app.js.78d34a4a26cfe0d786a6.hot-update.js.map