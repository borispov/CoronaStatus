...
})(["display:flex;flex-direction:column;justify-content:center;background:", ";padding:4px 2px;height:auto;position:absolute;z-index:999;top:0;right:0;border-bottom-left-radius:6px;border-bottom-right-radius:6px;transition:transform 0.22s ease-in-out;transform:", ";@media (max-width:", "){width:100%;}a{cursor:pointer;font-size:2rem;position:relative;font-weight:bold;letter-spacing:0.5rem;color:", ";text-decoration:none;transition:color 0.15s linear;@media (max-width:", "){font-size:1.5rem;text-align:center;}&:hover{color:", ";}}"], function (props) {
...
//# sourceMappingURL=_app.js.b58a1a83a1a8db35e6a8.hot-update.js.map