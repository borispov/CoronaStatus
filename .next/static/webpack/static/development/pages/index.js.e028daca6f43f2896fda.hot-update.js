        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              URL = baseURL + country; // const data = await axios.get(URL)
              //   .then(res => res.data)
              //   .catch(err => setError(err))

              _context2.next = 11;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(baseURLv2).then(function (res) {
                return res.data[country];
              })["catch"](function (err) {
                return setError(err);
              }));
            ...
            case 11:
              data = _context2.sent;
              timeStats = Object(_sortExternalApi__WEBPACK_IMPORTED_MODULE_4__["default"])(data); // const timeStats = sortForChart(data, theme);
...
//# sourceMappingURL=index.js.e028daca6f43f2896fda.hot-update.js.map