...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";flex-direction:column;width:100%;max-width:100%;justify-content:space-between;padding:0;margin:16px auto;height:auto;@media (max-width:768px){height:100px;}"], function (props) {
...
})(["display:block;width:124px;height:auto;border:1px solid gray;border:0;margin-left:12px;flex:0 0 20%;img{width:124px;height:auto;}@media (max-width:768px){margin-left:8px;}"]);
...
//# sourceMappingURL=News.js.110b84755bf7c9e8f56d.hot-update.js.map