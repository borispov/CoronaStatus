...
function useTime(country) {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function useTime$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    setLoading(true);
                    setError();
                    URL = cn === 'world' ? baseURL : baseURL + country || geo;
                    _context2.next = 5;
          ...
          _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(''), geo = _useState5[0], setGeo = _useState5[1]; // useEffect(() => {
...
//# sourceMappingURL=index.js.f91697d0a5b2912ab4f8.hot-update.js.map