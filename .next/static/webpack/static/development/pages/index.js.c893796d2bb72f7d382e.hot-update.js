...
})(["text-align:center;padding:8px 10px;font-weight:700;border-right-width:1px;border-left:2px solid;border-right-color:2px solid;border-color:", ";flex:0 0 20%;max-width:20%;position:relative;width:100%;display:flex;flex-direction:column;background:", ";color:", ";justify-content:center;border:1px solid ", ";"], function (props) {
  return props.theme.secondary;
}, function (props) {
  return props.bg && props.theme[bg] || props.theme.primaryColor;
}, function (props) {
...
//# sourceMappingURL=index.js.c893796d2bb72f7d382e.hot-update.js.map