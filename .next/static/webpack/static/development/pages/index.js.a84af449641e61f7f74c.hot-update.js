...
})(["position:relative;background:", ";color:", ";padding:0.350rem 0.85rem;font-size:12px;font-weight:400;font-family:'Roboto';outline:none;text-align:center;border:none;border-radius:6px;margin:0 6px;margin-left:16px;"], function (props) {
  return props.theme.statColor;
}, function (props) {
  return props.theme.scolor || '#111';
});
...
//# sourceMappingURL=index.js.a84af449641e61f7f74c.hot-update.js.map