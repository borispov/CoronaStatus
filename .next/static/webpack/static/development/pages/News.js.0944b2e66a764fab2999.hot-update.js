...
})(["margin:8px 12px;display:flex;padding:16px 6px;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";flex-direction:column;width:100%;max-width:100%;justify-content:space-between;padding:0;margin:16px auto;height:auto;@media (max-width:768px){height:auto;}"], function (props) {
...
})(["display:block;width:124px;height:auto;border:0;margin-left:12px;flex:0 0 20%;img{width:124px;height:100%;}@media (max-width:768px){margin-left:8px;}"]);
...
//# sourceMappingURL=News.js.0944b2e66a764fab2999.hot-update.js.map