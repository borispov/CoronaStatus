...
})(["margin-top:10px;color:", ";font-size:3.5rem;font-family:'Montserrat';text-align:center;text-shadow:0 1px 35px rgba(5,35,10,0.2);cursor:pointer;font-family:'Montserrat';@media (max-width:580px){font-size:3rem;align-items:flex-end;}"], function (props) {
...
//# sourceMappingURL=_app.js.6aaaada3646f990feb7b.hot-update.js.map