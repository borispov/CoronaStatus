...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  console.log('--------------');
  console.log(props.dataWorld);
  console.log('--------------');
  console.log(props.dataCountry);
  console.log('--------------');
  var data = {
    // labels: subtractArray(props.labels),
    labels: props.labels,
    // datasets: props.datasets && parseDatasets(props.datasets)
    // datasets: props.data.datasets.filter(a => a.label === 'cases')
    datasets: props.w ? props.dataWorld : props.dataCountry
  };
  var options = {
    responsive: true,
...
//# sourceMappingURL=index.js.1ef083783396ffe67161.hot-update.js.map