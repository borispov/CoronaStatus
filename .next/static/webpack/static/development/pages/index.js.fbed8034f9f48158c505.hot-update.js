  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function worldTimeData2$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          baseURL = "http://covid19.borisky.me:3003/api/v1/alltime/"; // const data = await axios.get(baseURL)

          _context.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(fetch(baseURL) // .then(res => sortForChart(res.data))
          .then(function (res) {
            return res.data;
          })["catch"](function (err) {
...
//# sourceMappingURL=index.js.fbed8034f9f48158c505.hot-update.js.map