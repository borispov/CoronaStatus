...
})(["margin:8px 12px;display:flex;flex-direction:row;padding:16px 6px;border:1px solid gray;justify-content:space-between;@media (max-width:768px){width:100%;max-width:100%;flex-direction:column;justify-content:space-between;border-radius:6px;border:1px solid ", ";border-top:6px solid ", ";padding:0;}"], function (props) {
...
})(["margin-left:42px;width:48px;height:48px;display:block;border:1px solid gray;@media (max-width:768px){margin:auto;width:96px;height:96px;border:0;flex:0 0 20%;img{width:96px;height:96px;border-radius:4px;border-top-right-radius:0px;}}"]);
...
//# sourceMappingURL=News.js.54dd8f003b562e6458c4.hot-update.js.map