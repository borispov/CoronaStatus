...
})(["direction:ltr;display:flex;flex-direction:column;position:relative;height:82px;width:100%;background:linear-gradient(45deg,#5c0434,#000000d6);border-bottom:1px solid darkblue;margin:0 auto;margin-bottom:48px;"]);
...
})(["display:flex;align-items:center;@media (max-width:768px){flex-direction:column;justify-content:flex-start;}"]);
...
})(["margin-top:20px;margin-left:40px;list-style:none;display:flex;justify-content:space-between;align-items:center;@media (max-width:768px){margin-left:12px;margin-top:0;justify-content:center;}"]);
...
})(["margin-top:20px;color:#e6e6e6;font-size:3.5rem;font-family:monospace;text-align:center;text-shadow:0 1px 35px rgba(5,35,10,0.2);@media (max-width:768px){font-size:2.5rem;}"]);
...
//# sourceMappingURL=index.js.a40095a50f236927838a.hot-update.js.map