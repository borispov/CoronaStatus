...
})(["margin-left:42px;width:48px;height:48px;display:block;border:1px solid gray;@media (max-width:768px){margin:auto;width:96px;height:96px;border:0;flex:0 0 20%;img{width:96px;height:96px;border-top-right-radius:'';border-radius:4px;}}"]);
...
//# sourceMappingURL=News.js.3fced18205ef1bc0dc1d.hot-update.js.map