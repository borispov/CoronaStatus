...
function Stats(_ref) {
  ...
  var organizeData = function organizeData(stats) {
    ...
    var mapToKeyword = function mapToKeyword(k) {
      return Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, switchToVocab(k), prop(stats)(k));
    };

    Object.entries(stats).map(mapToKeyword);
  };
...
//# sourceMappingURL=index.js.4de62ccb7be0180c045b.hot-update.js.map