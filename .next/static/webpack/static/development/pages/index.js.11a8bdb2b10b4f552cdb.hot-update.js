    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_14___default.a.get(baseURL) // .then(res => sortForChart(res.data))
          .then(function (res) {
            return res.data;
          })["catch"](function (err) {
            return setError(err);
...
//# sourceMappingURL=index.js.11a8bdb2b10b4f552cdb.hot-update.js.map