...
})(["position:relative;background:", ";color:", ";padding:0.250rem 0.55rem;font-size:12px;font-weight:400;font-family:'Roboto';outline:none;text-align:center;border:none;border-radius:6px;margin:0 6px;margin-left:16px;"], function (props) {
  return props.theme.color;
}, function (props) {
  return props.theme.bgColor;
});
...
//# sourceMappingURL=index.js.3ba7423a4dcf869baced.hot-update.js.map