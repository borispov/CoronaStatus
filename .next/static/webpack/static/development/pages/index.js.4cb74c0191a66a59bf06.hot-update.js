...
var CoronaApp = function CoronaApp(_ref) {
  ...
  var countryheb = function countryheb(x) {
    return countries && _assets_cns_js__WEBPACK_IMPORTED_MODULE_12__["default"][countries.indexOf(x)];
  };

  console.log(countries && country);
  console.log(countries && countries.indexOf(country)); // const selectOptions = countries && countries.map(a => ({ value: a, label: a }))
  ...
  return __jsx("div", {
    ...
    className: 'Select',
    options: selectOptions // value={country === 'Israel' && isHeb ? 'ישראל' : country}
    ,
    value: country && isHeb ? countryheb(country) : country,
...
//# sourceMappingURL=index.js.4cb74c0191a66a59bf06.hot-update.js.map