...
})(["text-align:center;padding:8px 10px;font-weight:700;border-left:2px solid;border-right-color:2px solid;border-color:", ";flex:0 0 20%;max-width:20%;position:relative;width:100%;display:flex;flex-direction:column;background:", ";color:", ";justify-content:center;"], function (props) {
...
})(["box-shadow:", ";border-radius:6px;margin-bottom:16px;border:1px solid ", ";"], function (props) {
...
//# sourceMappingURL=index.js.8a2d559a1b5c4d03de2e.hot-update.js.map