...
})(["font-weight:700;font-family:'Rubik';color:", ";@media (max-width:768px){max-width:fit-content;}"], props => props.theme.color);
...
const News = ({
  ...
  const detectMobile = Object(_utils_isMobile__WEBPACK_IMPORTED_MODULE_5__["default"])();
  ...
  const newsToTemplate = news => {
    return news.map((item, idx) => __jsx(NewsCard, {
      ...
      __self: undefined
    }, detectMobile.isMobile() ? shortenSnippet(item.description) : item.description)))), __jsx(_components_S__WEBPACK_IMPORTED_MODULE_2__["Flex"], {
